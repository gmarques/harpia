                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        @foreach($periodo['disciplinas'] as $disciplina)
                                            <tr>
                                                ...
                                                <td><a href="{{route('integracaouema.ofertas.migrar', $disciplina['ofd_id'])}}" @if(empty($disciplina['ito_codigo_prog'])) disabled="disabled" @endif class="@if(empty($disciplina['ito_codigo_prog'])) disabled @endif btn btn-warning btn-mapear-disciplina"><i class="fa fa-exchange"></i> Migrar notas</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
